...
const Footer = () => {
  ...
  return (
    <footer>
      <div className="max-w-7xl mx-auto mt-8 border-t border-gray-200 dark:border-gray-700 py-12 px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row md:items-center md:justify-between space-y-8 md:space-y-0">
