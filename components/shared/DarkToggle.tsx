...
const DarkToggle = () => {
  ...
  return (
    ...
    >
      ...
      <span
        aria-hidden="true"
        className="absolute -translate-x-1 dark:translate-x-9 bg-gray-50 dark:bg-gray-900 group-hover:bg-white dark:group-hover:bg-black pointer-events-none inline-block w-8 h-8 rounded-full transition ease-in-out duration-200"
      />
      {/* Sun icon. */}
