...
const DarkToggle = () => {
  ...
  return (
    <div className="inline-flex items-center space-x-2">
      {/* Sun icon. */}
      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-900 dark:text-gray-50" viewBox="0 0 20 20" fill="currentColor">
      ...
      >
        ...
        <span
          aria-hidden="true"
          className="translate-x-0 dark:translate-x-5 bg-gray-50 dark:bg-gray-900 pointer-events-none inline-block w-5 h-5 rounded-full transition ease-in-out duration-200"
        />
      </Switch>
      {/* Moon icon. */}
      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-900 dark:text-gray-50" viewBox="0 0 20 20" fill="currentColor">
